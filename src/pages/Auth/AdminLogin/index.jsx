        ...
        <div className='w-full max-w-md py-8 sm:py-12 my-auto animate-fade-in'>
          ...
          >
            ...
            <div className='mb-8 text-center select-none'>
              ...
              {/* Admin Badge */}
              <div className='mx-auto mb-3 flex w-fit items-center gap-1.5 rounded-full bg-gray-900/5 px-3.5 py-1 text-xs font-bold text-gray-800 ring-1 ring-gray-900/10 uppercase tracking-wide shadow-3xs'>
                <Shield className='size-3.5 text-gray-700' />
              ...
              <Text className='text-gray-500 text-sm font-medium'>
                Sign in to your administration account to manage users and platform settings.
              </Text>
            </div>
