...
export default function Hero() {
    const specialFeatures = ['Expert Instructors', 'Lifetime Access', 'Self-Paced Learning'];
    ...
    return (
        <section className='flex flex-col items-center justify-center px-4 md:px-16 lg:px-24'>
            ...
            <a href='/courses' className='mt-32 flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm font-medium transition hover:bg-gray-100/80'>
                ...
                <p className='flex items-center gap-1'>
                    <span>Start your learning journey with free foundational courses!</span>
                    <ChevronRight className='size-4' />
                </p>
            </a>

            <h1 className='mt-4 max-w-3xl scale-105 bg-linear-to-r from-black to-[#748298] bg-clip-text text-center text-4xl/12 font-bold text-transparent md:scale-100 md:text-6xl/20'>Master the Skills of Tomorrow, Today.</h1>
            <p className='mt-2 max-w-xl text-center text-base/7 text-gray-700'>Access high-quality lectures, interactive quizzes, and hands-on projects designed by expert mentors to help you land your dream job.</p>

            <a href='/courses' className='mt-8 flex items-center gap-2 rounded-full bg-gray-900 px-8 py-2.5 font-medium text-white transition hover:opacity-90'>
